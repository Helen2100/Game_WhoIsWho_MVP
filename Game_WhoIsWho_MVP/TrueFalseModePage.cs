...
{
    public partial class TrueFalseModePage : Form
    {
        int quectionCount;
        int correctAnswers;
        int wrongAnswers;
            ...
            try
            {
                Read = new System.IO.StreamReader(
                    System.IO.Directory.GetCurrentDirectory() +
                                                                @"\questionsForTrueFalseModePage.txt", encoding);
        ...
        private void TrueFalseModePage_Load(object sender, EventArgs e)
        {
            button1.Text = "Следующий вопрос";
